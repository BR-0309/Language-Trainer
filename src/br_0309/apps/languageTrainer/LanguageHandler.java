...
public class LanguageHandler {
    ...
    public static final Locale[] LANGUAGES = {new Locale("af", "ZA"), new Locale("an", "ES"), new Locale("ay", "BO"),
            ...
            new Locale("co", "FR"), new Locale("cs", "CZ"), new Locale("da", "DK"), Locale.UK, new Locale("eo"),
            new Locale("et", "EE"), new Locale("eu", "ES"), new Locale("ff"), new Locale("gl", "ES"), Locale.GERMANY,
            ...
            new Locale("hr", "HR"), new Locale("io"), new Locale("is", "IS"), new Locale("it", "IT"),
            new Locale("kg", "CD"), new Locale("la"), new Locale("lb", "LU"), new Locale("mi", "NZ"),
            ...
            new Locale("to", "TO"), new Locale("tr", "TR"), new Locale("ve", "ZA"), new Locale("vo"),
