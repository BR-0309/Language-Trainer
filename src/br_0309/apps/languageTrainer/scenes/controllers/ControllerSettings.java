...
public class ControllerSettings implements Initializable {
	...
	public void playCorrect() {
		...
		try {
			audioIn = AudioSystem.getAudioInputStream(getClass().getResourceAsStream(map.get(boxCorrect.getSelectionModel().getSelectedItem())));
	...
	public void playIncorrect() {
		AudioInputStream audioIn = null;
		try {
			audioIn = AudioSystem.getAudioInputStream(getClass().getResourceAsStream(map.get(boxIncorrect.getSelectionModel().getSelectedItem())));
			Clip clip = AudioSystem.getClip();
			clip.open(audioIn);
			clip.start();
		} catch (UnsupportedAudioFileException | IOException | LineUnavailableException e) {
	...
	public void playFinished() {
		AudioInputStream audioIn = null;
		try {
			audioIn = AudioSystem.getAudioInputStream(getClass().getResourceAsStream(map.get(boxFinished.getSelectionModel().getSelectedItem())));
			Clip clip = AudioSystem.getClip();
			clip.open(audioIn);
			clip.start();
		} catch (UnsupportedAudioFileException | IOException | LineUnavailableException e) {
